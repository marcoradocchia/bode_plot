...
* __plot_win__, __plot_linux__: plots data in a given _.csv_ file (columns in the input file need to be [frequency, input voltage, output voltage, gain, gain (dB), phase])